...
class ItemTest(BaseTest):
    def setUp(self):
        super(ItemTest, self).setUp() #MMK get the setup method of the superclass - otherwise this setup will overwrite the other and the other superclass method will not run.
        with self.app() as c:
            with self.app_context():
                ...
                self.auth_header = "JWT {}".format(json.loads(auth_request.data)['access_token']) #required JWT/Flask format
